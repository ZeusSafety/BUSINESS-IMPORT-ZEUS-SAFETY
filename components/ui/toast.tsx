    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed top-28 right-4 z-[9999] flex max-w-sm items-start gap-3 rounded-lg border border-emerald-200 bg-white px-4 py-3.5 shadow-xl shadow-black/20 sm:top-32"
