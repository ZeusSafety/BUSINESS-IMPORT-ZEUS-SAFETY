        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((cat) => {
            ...
            return (
              <div
                key={cat}
                className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-white via-white to-[#e7f2ff] p-5 transition hover:-translate-y-1 hover:shadow-lg"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,181,226,0.18),transparent_35%)] opacity-0 transition-opacity group-hover:opacity-100" />
                <div className="relative flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#103a7b] text-[#00d2ff]">
                    <Icon className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-wide text-[#0b2d60]">
                      Línea EPP
                    </p>
