...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0f1a34] via-[#0b2d60] to-[#0c1427] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,181,226,0.18),transparent_25%),radial-gradient(circle_at_90%_10%,rgba(255,255,255,0.08),transparent_30%)]" />
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-18 sm:py-20 sm:px-6 lg:grid-cols-2 lg:px-8">
        <motion.div
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-[4/5] overflow-hidden rounded-3xl bg-[radial-gradient(circle_at_30%_30%,rgba(0,181,226,0.35),transparent_45%),radial-gradient(circle_at_90%_20%,rgba(255,255,255,0.12),transparent_40%),linear-gradient(145deg,#0b2d60,#103a7b)] p-6 shadow-2xl">
