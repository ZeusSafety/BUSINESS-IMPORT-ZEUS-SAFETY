...
export function ProductImageZoom({ src, alt }: ProductImageZoomProps) {
  ...
  if (!src) {
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center border border-slate-200 bg-[#f4f5f7] sm:min-h-[480px] lg:min-h-[560px]">
  ...
  return (
    <>
      <button
        ...
        className="group relative block min-h-[320px] w-full cursor-zoom-in overflow-hidden border border-slate-200 bg-[#f4f5f7] sm:min-h-[480px] lg:min-h-[560px]"
      ...
      >
        ...
        />
        <span className="absolute bottom-4 right-4 inline-flex items-center gap-1.5 bg-[#0b2d60] px-3 py-1.5 text-[10px] font-bold uppercase tracking-wide text-white opacity-0 transition-all duration-200 group-hover:opacity-100">
